...
dict = {
    'fishing':{
      ...
      'timeouts':{
        ...
        'before_cast': {
          'min': config['fishing']['timeouts']['before_cast']['min'],
          'max': config['fishing']['timeouts']['before_cast']['max']
        }
      }
    },
    'repairing':{
    ...
    'moving':{
      'every': IntVar(value=config['moving']['every']),
      'enable': IntVar(value=config['moving']['enable']),
      'arm_disarm': {
        'min': config['moving']['arm_disarm']['min'],
        'max': config['moving']['arm_disarm']['max']
      },
      'move_time': {
        'min': config['moving']['move_time']['min'],
        'max': config['moving']['move_time']['max']
      },
      'timeouts': {
        'min': config['moving']['timeouts']['min'],
        'max': config['moving']['timeouts']['max']
      }
    },
    'bait':{
...
def save_data():
    ...
    'fishing':{
      ...
      'timeouts':{
        ...
        'before_cast': {
          'min': dict['fishing']['timeouts']['before_cast']['min'],
          'max': dict['fishing']['timeouts']['before_cast']['max']
        }
      }
    },
    'repairing':{
    ...
    'moving':{
      'every': dict['moving']['every'],
      'enable': dict['moving']['enable'],
      'arm_disarm': {
        'min': dict['moving']['arm_disarm']['min'],
        'max': dict['moving']['arm_disarm']['max']
      },
      'move_time': {
        'min': dict['moving']['move_time']['min'],
        'max': dict['moving']['move_time']['max']
      },
      'timeouts': {
        'min': dict['moving']['timeouts']['min'],
        'max': dict['moving']['timeouts']['max']
      }
    },
    'bait':{
